# Fast Forward Academy — Application Strategy & Draft (2026)

**Program:** Fast Forward Academy (https://www.ffwd.org/academy)
**Application form:** https://tally.so/r/xXgb0G
**Deadline: July 17, 2026** · Rolling interviews · Decisions by Aug 30
**Program:** Oct 5 – Nov 9, 2026 (virtual, ~4 hrs/week + build time) · **Mandatory in-person week in San Francisco, Oct 18–23**
**Award:** $10,000 grant + AI/product/GTM guidance + peer cohort
**Questions:** academy@ffwd.org

---

## 1. The positioning decision

**We are NOT applying as FinMango.** The Academy is built for early-stage founders taking an
AI-powered nonprofit product from MVP to beta. FinMango is a 9-year-old 501(c)(3) with global
reach and a pending SFF long-form application — it reads as too mature for this program, and
applying as FinMango would muddy the SFF story (where FinMango is positioned as an established
research org requesting ~$750K).

**We ARE applying as a new venture that comes out of FinMango:**
...
The single hardest thing for MVP→beta founders is **getting real users**. Our unfair advantage:

1. **A built-in classroom beta channel.** FinMango's in-school programming runs in 27 high
   schools and colleges via lead instructor Bob Gillingham, reaching ~8,000 students per year.
   The Academy runs Oct 5 – Nov 9 — mid-semester. We can run a live classroom beta *during the
...
## 3. Draft answers — question by question

### About You

| Field | Answer |
|---|---|
| First / Last name | Scott Glasgow |
| Email | scott@finmango.org |
| LinkedIn URL | *(Scott's LinkedIn)* |
| Where are you based? | Ohio |
| Current day job / primary role | Founder & Executive Director, FinMango (501c3) — transitioning to a board role to build this venture as my primary focus |
| How did you hear about the Academy? | Newsletter *(arrived via FFWD email)* |
| Other accelerators/courses? | Answer honestly; if none, "No" |
| Share application with partners / Funding Fwd / directory? | **Yes** — free funder exposure, no downside |

### Your Video (≤3 min — demo + "Why does the world need this right now?")
...
> *(Answer honestly; the pipeline is the story, not the current count.)*

**When did you begin working on this?** → 2026

**How many hours per week are you currently spending on this?**
> *(Scott: fill honestly — and note it increases as the FinMango board transition completes.)*
...
**Your relationship with AI — how long, and how it shows up day-to-day?** *(personalize!)*
> Daily, as a builder. AI coding agents ship most of FinMango's web tools, and our research
> (Financial Health Barometer, AI Economic Signal) turns large-scale search signals into
> real-time indicators. Over the past year I've prototyped AI products end-to-end myself —
> prompting, evals, guardrails, deployment. AI went from something I wrote about to the thing
...
> Instead of walking away, I noticed the foundation was the part people actually cared about —
> so I rebuilt around it as a nonprofit. That "failure" became an organization whose work has
> been used by Google Health, the WHO, and the World Bank. I treat broken things as information
> about what to build next. (~400 chars)

**Have you raised outside funding for this project?** → **No**
> *(Answer for THIS project, not FinMango. FinMango's incubation gets disclosed in "Anything
> else" — cleaner than muddying this answer.)*
...
> Generic startup content or demo-day theater. I don't need convincing that tech nonprofits
> matter — I've run one for nine years. I need six focused weeks of building, blunt feedback,
> and peers who will call out my weak assumptions.

**Six-week sprint + SF week Oct 18–23 — can you commit?** → **Yes** *(confirm calendar first)*

**Anything else you want us to know?**
> This venture spins out of FinMango, the 501(c)(3) I founded: FinMango provides fiscal
> support and the classroom beta channel, and I'm transitioning to FinMango's board so this
> becomes my primary focus. The beta will run live in partner classrooms during the Academy
> itself — by the final week we expect real usage data from a few hundred students.

### Founder Demographics (optional)
> Entirely Scott's call; no strategic weight either way.
...
- [ ] Confirm board-transition framing is OK to state publicly (FFWD may share the app with partners).
