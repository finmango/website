...
const stories = [
  ...
  },
  {
    ...
    slides: [
      ...
      { emoji: "🌱", title: "Some Hopeful News", text: "", html: "<div class='slide-bullets'><p>• Momentum! Over 400 land-use change bills introduced in early 2025.</p><p>• Housing finance reforms enacted through the One Big Beautiful Bill Act, like permanently raising 9% credit allocations and cutting bond financing thresholds from 50% to 25%.</p><p>• Wages rising (a 3.5% projected increase in 2026) and 19 states raised their <a href='https://www.epi.org/minimum-wage-tracker/#/min_wage/Washington' target='_blank' rel='noopener' style='color:#F25A27;font-weight:700;text-decoration:underline;'>minimum wages</a>.</p></div>" },
  ...
  },
  {
    ...
    slides: [
      ...
      { emoji: "👤", title: "Use a HUD-approved housing counselor", text: "", html: "<div class='slide-bullets'><p>Get expert advice from a HUD-approved counselor or agency to help guide your decision.</p><p><a href='https://answers.hud.gov/housingcounseling/s/?language=en_US' target='_blank' rel='noopener' style='color:#F25A27;font-weight:700;text-decoration:underline;'>Find a HUD-approved housing counselor near you →</a></p></div>" },
      { emoji: "🗣️", title: "Advocate", text: "", html: "<div class='slide-bullets'><p>Advocate for yourself and your community's housing needs through attending zoning meetings or speaking with your member of congress.</p><p><a href='https://nlihc.org/take-action' target='_blank' rel='noopener' style='color:#F25A27;font-weight:700;text-decoration:underline;'>Take action with NLIHC →</a></p></div>" },
      ...
      { emoji: "⏱️", title: "Ownership Timeline calculator", text: "", html: "<div class='slide-bullets'><p>Determining the right type of housing, the appropriate down payment, or how much to save each month can be daunting. Use our calculator to help you plan!</p><p><a href='housing-calculator.html' style='color:#F25A27;font-weight:700;text-decoration:underline;'>Open the Ownership Timeline Calculator →</a></p></div>" }
    ]
  }
];
